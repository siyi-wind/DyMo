'''https://github.com/zzachw/MUSE/blob/main/src/core/gnn.py'''
...
class MML(nn.Module):
    ...
    def forward(self, x, x_flag, y, y_flag):
        ...
        return 0.5 * unsup_loss + 0.5 * sup_loss + cls_loss, logits

    def inference(self, x, x_flag):
        batch_size = x.shape[0]
        hidden_dim = x.shape[-1]
