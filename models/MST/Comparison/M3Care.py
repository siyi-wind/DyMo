...
if __name__ == "__main__":
    ...
    args = {'MST':{"transformer_dim": 32, "transformer_heads": 2, "transformer_layers": 2, "transformer_drop": 0.0, 
                         "num_patches_list": [1, 1, 1], 'embedding_size': 32, 'num_gnn_layers': 2, 'lambda_stab': 1e-8,
                         'num_masks': 0, 'augmentation_K': None}, 
                         'dataset_name': 'MST', 'num_classes': 10,
                         'alphabet': alphabet, 'modality_names': ['mnist', 'svhn', 'text'],
