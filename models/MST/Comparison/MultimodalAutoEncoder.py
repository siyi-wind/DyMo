...
class MultiAE(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.m_decoders = nn.ModuleDict({
                'mnist': DecoderImg(None),
                'svhn': DecoderSVHN(None),
                'text': DecoderText(None, num_text_features),
                })
...
if __name__ == "__main__":
    ...
    args = {'MST':{'embedding_size':32, 'augmentation_K': None}, 
    ...
    x = {'mnist': torch.randn(2, 1, 28, 28), 'svhn': torch.randn(2, 3, 32, 32), 'text': one_hot_tensor}
