...
if __name__ == "__main__":
    ...
    args = {'MST':{"embedding_size": 20, 'imputer_name': 'MoPoE', 'augmentation_K': None,
                         ...
                         'checkpoint': None, 'alphabet': alphabet, 'len_sequence': 8,
                         'dataset_name': 'MST', 'batch_size':2, 'logdir':None, 'modality_names': ['mnist', 'svhn', 'text'],
