...
class OnlineMAE(nn.Module):
    ...
    def __init__(self, args):
        ...
        if args[args.dataset_name].encoder_checkpoint:
            ...
            for module, module_name in zip(self.m_encoders.values(), ['model.encoder_imaging.', 'model.encoder_tabular.']):
    ...
    def forward_recon(self, x: Dict, mask: torch.Tensor, random_masking: bool = True):
        ...
        for i, name in enumerate(self.modality_names):
            ...
            tmp = self.m_projection[name](tmp)
...
if __name__ == "__main__":
    ...
    args = {'DVM':{"transformer_dim": 256, "transformer_heads": 2, "transformer_layers": 2, "transformer_drop": 0.0, "num_patches_list": [1, 1], 
                         "recon_encoder_layers":2, "recon_decoder_layers": 2, "num_mem_tokens": 4,
                ...
                "num_modalities": 2, "num_classes": 286}
    ...
    loss, output = model.forward_train(x, mask, torch.tensor([0, 1]))
    for item in output:
        print(item.shape)
