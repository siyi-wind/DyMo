...
class DyMo(nn.Module):
    ...
    def forward(self, x: Dict, mask: torch.Tensor, y: torch.Tensor):
        mask = mask.bool()
        with torch.no_grad():
...
if __name__ == "__main__":
    ...
    args = {'CelebA':{"transformer_dim": 32, "transformer_heads": 2, "transformer_layers": 2, "transformer_drop": 0.0, 
                         "num_patches_list": [1,1], "num_masks": 0, 'imputer_name': 'MoPoE', "distance_metric": "cosine_similarity",
                         ...
                         'transformer_checkpoint': '/home/siyi/project/mm/result/Dynamic_project/CA4/train_nonenone_CelebA_DynamicTransformer_singleCLS_0516_121309/downstream/checkpoint_best_auc.ckpt',
                         'quality_metric_name': 'prototype_distance', 'projection_dim': 16}, 
                         'checkpoint': None, 'num_classes': 2,
                         'dataset_name': 'CelebA', 'batch_size':2, 'logdir':None,
                "num_modalities": 2, 'alphabet': alphabet, 'modality_names': ['img', 'text'],'len_sequence': 256}
