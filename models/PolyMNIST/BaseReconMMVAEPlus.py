...
class ReconMMVAEPlus(nn.Module):
    def __init__(self, args):
        ...
        self.model = MMVAEPlus(model_config, encoders, decoders)
        if args.checkpoint:
...
if __name__ == "__main__":
    args = {'PolyMNIST':{"transformer_dim": 128, "transformer_heads": 4, "transformer_layers": 2, "transformer_drop": 0.0, "num_patches_list": [1, 1, 1, 1, 1], 
                ...
                "num_modalities": 5, "checkpoint": "/home/siyi/project/mm/result/Dynamic_project/PM52/reproduce_mmvaePlus/K__1/MMVAEPlus_training_2025-09-01_18-33-01/final_model/model.pt", 'logdir': None, 'batch_size': 2,
                "downstream_strategy": "frozen", "num_classes": 10}
    args = OmegaConf.create(args)
    model = ReconMMVAEPlus(args)
