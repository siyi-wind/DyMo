...
class CMVAE_Classification(nn.Module):
    '''
    Use CMVAE to get a shared hidden representation for all modalities.
    '''
    def __init__(self, args):
        super(CMVAE_Classification, self).__init__()
    ...
    def create_imputation_network(self, args):
        assert args[args.dataset_name].imputer_name == 'CMVAE', 'Only CMVAE is supported'
        args_imputer = args
...
if __name__ == "__main__":
    args = {'PolyMNIST':{"embedding_size": 32, 'imputer_name': 'CMVAE', 'augmentation_K': None,
                         'imputer_checkpoint': '/home/siyi/project/mm/result/Dynamic_project/PM51/reproduce_cmvae/K__1/CMVAE_training_2025-09-01_16-26-14/final_model/model.pt'},
                         'checkpoint': None,
                         'dataset_name': 'PolyMNIST', 'batch_size':2, 'logdir':None, 'modality_names': ['m0', 'm1', 'm2', 'm3', 'm4'],
                "num_modalities": 5, "num_classes": 10}
    args = OmegaConf.create(args)
    model = CMVAE_Classification(args)
