...
if __name__ == "__main__":
    args = {'PolyMNIST':{"transformer_dim": 128, "transformer_heads": 4, "transformer_layers": 2, "transformer_drop": 0.0, 
                         "num_patches_list": [1, 1, 1, 1, 1], 'embedding_size': 128, 'num_gnn_layers': 2, 'lambda_stab': 1e-8,
                         'num_masks': 0, 'augmentation_K': None}, 
                         'dataset_name': 'PolyMNIST', 'num_classes': 10,
                         "modality_names": ["m0", "m1", "m2", "m3", "m4"], 
                "num_modalities": 5, "checkpoint": None}
    ...
    mask = torch.tensor([[True, False, False, False, True], [True, True, False, False, False]])  # 2 samples, 5 modalities
